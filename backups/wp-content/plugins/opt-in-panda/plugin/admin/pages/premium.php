        ...
        <div class="onp-page-section">
            ...
            <div class='factory-bootstrap-331'>
                <a class="btn btn-gold" id="onp-sl-purchase-btn" href="<?php echo onp_op_get_url_to_purchase( 'go-premium' ) ?>">
                    ...
                    Purchase Opt-In Panda Premium For $26 Only
                    <i class="fa fa-star"></i>
                </a>
            </div>
            ...
            <p style="text-align: center; margin-top: 20px;">
                <a href="<?php echo onp_op_get_url_to_purchase( 'go-premium' ) ?>" style="color: #111;"><strong>Or Buy The Opt-In Panda Right Now For $26 Only</strong></a>
            </p>
