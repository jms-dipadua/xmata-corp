 ...
 * @since 1.0.0
 */
function opanda_help_page_gdpr_email_locker( $manager ) {
    require BIZPANDA_EMAIL_LOCKER_DIR . '/admin/help/gdpr.php';
}

add_action('opanda_help_page_gdpr-email-locker', 'opanda_help_page_gdpr_email_locker');
