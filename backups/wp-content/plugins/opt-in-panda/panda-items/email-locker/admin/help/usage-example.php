...
<div class="onp-help-section">
    ...
    <p>
        <?php _e('Open the post editor for the post where you want to put the locker. Add a block named «Email Locker».', 'emaillocker') ?>
    </p>

    <p class='onp-img'>
        <img src='<?php echo 'https://cconp.s3.amazonaws.com/bizpanda/email-locker/blocks-widget.png' ?>' />
    </p>

    <p>
        <?php _e('Put content you wish to lock into the added block.', 'emaillocker') ?>
    </p>

    <p class='onp-img'>
        <img src='<?php echo 'https://cconp.s3.amazonaws.com/bizpanda/email-locker/edit-block.png' ?>' />
    </p>

    <p>
        <?php _e('If you have several lockers you can pick the concrete one by clicking on the block border.', 'emaillocker') ?>
    </p>

    <p class='onp-img'>
        <img src='<?php echo 'https://cconp.s3.amazonaws.com/bizpanda/email-locker/block-settings.png' ?>' />
    </p>

    <p>
        <?php _e('Also you can use shortcodes to call the locker by wrapping the content you wish to lock. For instance: <span class="onp-mark onp-mark-gray onp-mark-stricked onp-code">[emaillocker] Locked Content Goes Here [/emaillocker]</span>', 'emaillocker') ?>
    </p>
