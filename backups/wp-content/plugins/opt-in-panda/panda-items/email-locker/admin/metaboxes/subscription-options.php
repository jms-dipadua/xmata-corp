...
class OPanda_SubscriptionOptionsMetaBox extends FactoryMetaboxes321_FormMetabox
{
    ...
    public function configure( $scripts, $styles) {
        ...
        if ( OPanda_Items::isCurrentPremium() ) {
            $scripts->add( BIZPANDA_EMAIL_LOCKER_URL . '/admin/assets/js/custom-fields.010001.js');            
        }

        $styles->add( BIZPANDA_EMAIL_LOCKER_URL . '/admin/assets/css/subscription-options.050600.css');
        $scripts->add( BIZPANDA_EMAIL_LOCKER_URL . '/admin/assets/js/subscription-options.050600.js');
    ...
    public function form( $form ) {
        ...
        $options = apply_filters('opanda_extra_list_subscription_options', $options, $serviceName );
