...
class OPanda_EmailLockerMoreFeaturesMetaBox extends FactoryMetaboxes321_Metabox
{
    ...
    ?>
        ...
        <?php if ( $alreadyActivated || get_option('onp_sl_skip_trial', false) ) { ?>
            <div class="sl-footer">
                <?php echo sprintf(__('<a href="%s" class="btn btn-primary btn-large">Get Premium for $26<br /><span>(it will take a pair of minutes)</span></a>', 'optinpanda'), onp_licensing_325_get_purchase_url( $optinpanda, 'more-features' ), onp_licensing_325_manager_link($sociallocker->pluginName, 'activateTrial', false)); ?>
            </div>
        <?php } else { ?>
            <div class="sl-footer">
