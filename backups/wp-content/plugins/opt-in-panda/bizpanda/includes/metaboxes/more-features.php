...
class OPanda_MoreFeaturesMetaBox extends FactoryMetaboxes321_Metabox
{
 ...
 ?>
        ...
        <?php } else { ?>
            <div class="sl-footer">
                <?php echo sprintf(__('<a href="%s" class="btn btn-primary btn-large">Get Premium for $26<br /><span>(it will take a pair of minutes)</span></a>', 'bizpanda'), onp_licensing_325_get_purchase_url( $optinpanda ), onp_licensing_325_manager_link($optinpanda->pluginName, 'activateTrial', false)); ?>
            </div>
        <?php } ?>
