...
$bizpanda->load(array(
    array( 'libs/factory/bootstrap', 'factory_bootstrap_331', 'admin' ),
...
require(OPANDA_BIZPANDA_DIR . '/includes/assets-manager.php');
require(OPANDA_BIZPANDA_DIR . '/includes/post-types.php');
require(OPANDA_BIZPANDA_DIR . '/includes/shortcodes.php');
#endcomp

require_once OPANDA_BIZPANDA_DIR . '/extras/elementor/boot.php';
